...
╠🐞➽ ${prefix}sugerencia (DICA) 
╠🐞➽ ${prefix}evaluar (O-QUAO-BOM) 
║
╚════• 〘V3.0.0〙
╭──────────────⊣
│ PESQUISAS/BAIXAR
...
╠🐞➽ ${prefix}consejobiblico
╠🐞➽ ${prefix}Perfil
╠🐞➽ ${prefix}Calcular 1 + 1
╠🐞➽ ${prefix}hacernick (NICK)
╠🐞➽ ${prefix}metadinha
